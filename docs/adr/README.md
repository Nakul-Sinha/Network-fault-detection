...
PRD 17 invites ADRs for stack deviations. These are the decisions where the
build departed from the PRD, or where the PRD left a choice open and the
answer is not obvious from reading the code.
